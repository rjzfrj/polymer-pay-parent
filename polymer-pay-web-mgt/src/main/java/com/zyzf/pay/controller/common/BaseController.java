 ...
 */
package com.zyzf.pay.controller.common;
...
public abstract class BaseController {
	 ...
	 * @return
	 */
	protected ZyppOperator getZyppOperator() {
		ZyppOperator operator = (ZyppOperator) this.getSession().getAttribute("ZyppOperator");
		return operator;
	}
